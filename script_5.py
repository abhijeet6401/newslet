# Create the newsletter generator module with fixed indentation
newsletter_content = '''import logging
...
<body>
    <div class="newsletter-container">
        ...
        <div class="content">
            {self.generate_summary_section(articles)}
            
            {self.generate_statistics_section(articles)}
"""
        
        # Add content sections for each category
        for category, category_articles in categories.items():
            html_content += f'<div class="category-section">'
            html_content += f'<h2 class="category-header">{category} ({len(category_articles)} articles)</h2>'
...
print("File size:", len(newsletter_content), "characters")